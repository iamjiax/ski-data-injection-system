...
public class Constants {
  // Paths
  public static final String SERVER_IP = "35.90.155.166";
  ...
  public static final String ALB_PATH = "http://alb-ski-server-v2-827220274.us-west-2.elb.amazonaws.com/ski-server_war";
